...
/* returns string with the code word in the dollarsign */
/*ALREADY VERIFIES VALIDITY OF THE CHARS FOLLOWING THE $ */
/*DOES not handle the aspens just grabs what is after the $ */
...
/*substitui na string cmd   a codeword pela respetiva env_val

se nao for encontrada a env val da problems 
ver como fazer o management disso nas funcoes superiores que enviam os argumentos para esta
*/

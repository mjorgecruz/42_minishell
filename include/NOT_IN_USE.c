...
/*   Updated: 2024/01/31 10:56:02 by luis-ffe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (finds_specials_chars(str) == false)//se nao encontrar specials da avanca direto
	{
		printf("\nOK\n");
		return ;
	}
	...
	if (valid_start_signals(str) == false)				//falso da erro
	{
		printf("\nKO MANY SPECIALS\n");
		return ;
	}
